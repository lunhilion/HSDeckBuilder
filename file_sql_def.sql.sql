...
CREATE TABLE IF NOT EXISTS `mazzo` (
  `NomeMazzo` varchar(20) ,
  `IDutente` int(11) ,
  `Classe` varchar(20) NOT NULL,
  `Carta` varchar(40) ,
  `QuantitàCarta` int(11) DEFAULT '1',
  PRIMARY KEY(`NomeMazzo`,`IDutente`,`Carta`),
  FOREIGN KEY(`IDutente`) REFERENCES `utente` (`IDutente`),
  FOREIGN KEY(`Classe`) REFERENCES `classe` (`NomeClasse`),
...
(1, '1', 'admin', 'admin', '2016-12-06 10:43:17');
...
DROP TABLE IF EXISTS `utentepremium`;
CREATE TABLE IF NOT EXISTS `utentepremium` (
  `IDpremium` int(11) PRIMARY KEY,
  FOREIGN KEY(`IDpremium`) REFERENCES `utente` (`IDutente`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;