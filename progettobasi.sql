...
--
-- Host: 127.0.0.1
-- Creato il: Dic 02, 2016 alle 15:52
...
CREATE TABLE `carta` (
  ...
  `Rarità` varchar(20) COLLATE utf8_bin NOT NULL,
...
CREATE TABLE `mazzo` (
  `NomeMazzo` varchar(20) COLLATE utf8_bin NOT NULL,
  `IDutente` int(11) NOT NULL,
  `Classe` varchar(20) COLLATE utf8_bin NOT NULL DEFAULT 'Neutral',
  `Carta` varchar(40) COLLATE utf8_bin NOT NULL,
  `QuantitàCarta` int(11) NOT NULL DEFAULT '1'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='vincoli integ. ref. ID(Utente) e NomeCarta(Carta)';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='da inserire vincolo di integrità ref. con ID(Utente)';
...
--
ALTER TABLE `mazzo`
  ADD PRIMARY KEY (`NomeMazzo`,`IDutente`,`Carta`);
